...
public class DeviceRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<BleDevice> mUnclaimedDevices2 = new ArrayList<>();
    private Set<BleDevice> mUnclaimedDevices = new HashSet<>();
    private List<BleDevice> mClaimedDevices2 = new ArrayList<>();
    private Set<BleDevice> mClaimedDevices = new HashSet<>();
